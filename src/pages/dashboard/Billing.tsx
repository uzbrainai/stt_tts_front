...
const Billing = () => {
  ...
  const transactions = [
    { id: 1, type: 'Top-up', amount: 100, date: '2024-01-15', status: 'completed', description: 'Account credit added' },
    { id: 2, type: 'Usage', amount: -25.50, date: '2024-01-14', status: 'completed', description: 'API usage charges' },
    { id: 3, type: 'Top-up', amount: 50, date: '2024-01-10', status: 'completed', description: 'Account credit added' },
    { id: 4, type: 'Usage', amount: -15.75, date: '2024-01-09', status: 'completed', description: 'STT processing charges' },
  ];
