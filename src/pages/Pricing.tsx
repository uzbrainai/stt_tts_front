    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Choose the perfect plan for your voice AI needs. Scale up or down anytime with no long-term commitments.
        </p>
      </div>
      ...
      <div className="flex justify-center mb-12">
        <div className="bg-muted rounded-lg p-1 flex">
          <button className="px-6 py-2 rounded-md bg-background text-foreground font-medium transition-all">
            Monthly
          </button>
          <button className="px-6 py-2 rounded-md text-muted-foreground font-medium hover:text-foreground transition-all">
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {addOns.map((addon, index) => (
            <div key={addon.name} className="rounded-2xl border bg-card p-6 hover:shadow-lg transition-all duration-300">
              <h3 className="font-bold mb-2">{addon.name}</h3>
              <div className="mb-3">
                <span className="text-2xl font-bold text-primary">{addon.price}</span>
                <span className="text-muted-foreground text-sm ml-1">{addon.unit}</span>
              </div>
      ...
      <section className="text-center">
        <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-8 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            Start your free trial today and experience the power of advanced voice AI technology.
          </p>
