    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-r from-indigo-500 to-indigo-600 flex items-center justify-center">
                  <span className="text-3xl">🎵</span>
                </div>
                <h1 className="text-5xl font-bold">AI Music Detection</h1>
              </div>
              <p className="text-xl text-slate-300 mb-8">
                Distinguish between human-composed and AI-generated music with our advanced detection algorithms. 
                Protect musical authenticity and support original artists.
              </p>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">Comprehensive Music Analysis</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our AI music detection service uses advanced machine learning to analyze musical compositions
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
                  <div className="w-12 h-12 rounded-lg bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center mb-4 text-indigo-600 dark:text-indigo-400">
                    {feature.icon}
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-amber-700 dark:text-amber-200 mb-8">
                AI music detection is revolutionizing how the music industry maintains authenticity and protects artists
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground">AI music identification accuracy</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground">Supported music file formats</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground">Instant music analysis</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Protect Musical Authenticity?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Start detecting AI-generated music with our advanced analysis tools. Safeguard the music industry today.
          </p>
