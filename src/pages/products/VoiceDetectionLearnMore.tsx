          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-5xl font-bold">AI Voice Detection</h1>
              </div>
              <p className="text-xl text-slate-300 mb-8">
                Protect your platform from AI-generated voice content with our cutting-edge detection technology. 
                Identify deepfakes and synthetic voices with unprecedented accuracy.
              </p>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">Advanced Detection Features</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our AI voice detection service offers state-of-the-art technology to identify synthetic voices
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
                  <div className="w-12 h-12 rounded-lg bg-red-100 dark:bg-red-900 flex items-center justify-center mb-4 text-red-600 dark:text-red-400">
                    {feature.icon}
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-amber-700 dark:text-amber-200 mb-8">
                AI voice detection technology is essential for maintaining content authenticity across various platforms
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground">Detection accuracy rate</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground">Supported audio formats</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-pink-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Start detecting AI-generated voices with our powerful detection API. Protect your content today.
          </p>
