  ...
  const features = [
    {
      ...
      description: 'Human-like speech with natural intonation',
      icon: <Volume2 className="h-6 w-6" />
    },
    {
      title: 'Multiple Voice Options',
      description: 'Choose from dozens of professional voices',
      icon: <Users className="h-6 w-6" />
    },
    {
      title: 'Emotion Control',
      description: 'Add emotion and emphasis to speech',
      icon: <Settings className="h-6 w-6" />
    },
    {
      title: 'SSML Support',
      description: 'Advanced speech markup for precise control',
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-r from-purple-500 to-purple-600 flex items-center justify-center">
                  <span className="text-3xl">🔊</span>
                </div>
                <h1 className="text-5xl font-bold">Text-to-Speech</h1>
              </div>
              <p className="text-xl text-purple-300 mb-8">
                Convert any text into natural-sounding speech with our advanced neural text-to-speech technology. 
                Perfect for audiobooks, voice assistants, and accessibility features.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Create natural-sounding speech with industry-leading voice synthesis
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
                  <div className="w-12 h-12 rounded-lg bg-purple-100 dark:bg-purple-900 flex items-center justify-center mb-4 text-purple-600 dark:text-purple-400">
                    {feature.icon}
                  </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Audiobooks & Content</h3>
                    <p className="text-muted-foreground">Convert written content into engaging audio format</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Voice Assistants</h3>
                    <p className="text-muted-foreground">Power interactive voice experiences and chatbots</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Make content accessible for visually impaired users</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Transform Text into Speech</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Start creating natural-sounding audio content with our text-to-speech API.
          </p>
