...
const Products = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      description: 'Detect whether voice recordings are AI-generated or human. Perfect for content verification and authenticity checking.',
      features: ['Real-time analysis', 'High accuracy detection', 'Batch processing', 'API integration'],
    ...
    },
    {
      ...
      description: 'Identify AI-generated music tracks and distinguish them from human-composed pieces with advanced machine learning.',
      features: ['Music genre analysis', 'Composition pattern detection', 'Real-time scanning', 'Copyright verification'],
